    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-[#e5e5e5] flex flex-col">
      ...
      <div className="p-4">
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#f8f6f3]">
          <div className="w-9 h-9 rounded-full bg-[#d4854a] flex items-center justify-center text-white font-semibold text-sm">
            AD
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-[#1a1a1a] truncate">Admin Usuario</p>
            <p className="text-xs text-[#a3a3a3] truncate">admin@newlife.com</p>
          </div>
        </div>
        <Button
          variant="ghost"
